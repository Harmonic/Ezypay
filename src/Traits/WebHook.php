...
use harmonic\Enums\EzypayWebHookEventTypes;
...
trait WebHook {
    ...
    public function simulateWebHook(string $eventType) {
        ...
        if ($eventType !== null && !EzypayWebHookEventTypes::hasKey($eventType)) {
            throw new InvalidParameterException("Event type must be a valid event type from harmonic\Enums\EzypayWebHookEventTypes");
        }
